...
import { faPlus, faTrashAlt, faChevronDown, faClose } from '@fortawesome/free-solid-svg-icons';
        ...
        <>
            <div className="container EditeTaskNow" style={{
                ...
                <div className="row m-2 text-end">
                    <div className='Title-Task m-2'>تعديل مهام لاعضاء الكنترول</div>
                </div>
                <div className="row justify-content-center">

                    <div className="col-md">
                        <textarea placeholder='المهمة' rows="5" cols="55" className='TextAreaTask-2 text-end p-2' ></textarea>
                    </div>
                    <div className="col-md ">
                ...
                <div className="row m-2 text-end">
                    <div className='Title-Task m-2'>الاعضاء</div>
                </div>
