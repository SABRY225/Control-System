        ...
        <form  >
          <div className="row text-center">
            ...
            <div className="col-md-5" >
              <textarea placeholder='المهمة'style={{width:"22rem"}} rows="5" cols="55" className='TextAreaTask text-end p-2' ></textarea>
            </div>
          ...
          <div className="row text-center m-3">
            <div className="col">
              <button className='btn btn-info p-2' style={{ width: '200px', fontSize: "20px", background: "rgb(67, 187, 255)", color: "#FFFFFF" }}> ارسال المهمة</button>
            </div>
